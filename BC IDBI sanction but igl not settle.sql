--BC IDBI sanction but igl not settle

select zone,districtname,c.BranchID,BranchName,Ce.StaffID,F.StaffName,ClientID ,a.LoanProposalID,b.customername,b.LoanAmountApproved ,b.StatusRecievdDate,
...
union all
select zone,districtname as RegionName,c.BranchID,BranchName,Ce.StaffID,F.StaffName,ClientID ,a.LoanProposalID,b.customername,b.LoanAmountApproved ,
...
union all
select zone,districtname,c.BranchID,BranchName,Ce.StaffID,F.StaffName,a.ClientID ,a.LoanProposalID,b.customername,b.LoanAmountApproved ,d.SanctionDate,
